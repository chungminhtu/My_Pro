...
using MMHDemo.Migrations.Seed.Host;
...
namespace MMHDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MMHDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MMHDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(MMHDemoConsts.ConnectionStringName).Value.ToString();
        }
