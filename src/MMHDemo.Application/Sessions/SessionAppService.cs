...
{
    public class SessionAppService : MMHDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = MMHDemoConsts.Currency,
                    CurrencySign = MMHDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = MMHDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
