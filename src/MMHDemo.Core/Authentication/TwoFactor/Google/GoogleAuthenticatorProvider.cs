...
namespace MMHDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : MMHDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("MMHDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
