namespace MMHDemo.Authorization
{
    ...
    {
        public const string Pages_Emp1s = "Pages.Emp1s";
        public const string Pages_Emp1s_Create = "Pages.Emp1s.Create";
        public const string Pages_Emp1s_Edit = "Pages.Emp1s.Edit";
        public const string Pages_Emp1s_Delete = "Pages.Emp1s.Delete";
