...
namespace MMHDemo.MultiTenancy.Payments.Stripe
{
    //TODO: We may use a retry mechanism using the Poly library.

    public class StripeGatewayManager : MMHDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MMHDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MMHDemoConsts.Currency;
        }
