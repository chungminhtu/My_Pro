...
namespace MMHDemo.Migrations
{
    ...
    [Migration("20191228141549_Regenerated_Emp19192")]
    partial class Regenerated_Emp19192
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMHDemo.Test3.Emp1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MMHDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MMHDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MMHDemo.Test3.Emp1", b =>
                {
                    b.HasOne("MMHDemo.Chat.ChatMessage", "ChatMessageFk")
                        .WithMany()
