...
using MMHDemo.EntityFrameworkCore.Repositories;

namespace MMHDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : MMHDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<MMHDemoDbContext> dbContextProvider)
