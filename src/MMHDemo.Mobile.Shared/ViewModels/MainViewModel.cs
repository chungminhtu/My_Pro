...
using MvvmHelpers;
using MMHDemo.Authorization.Users.Profile;
using MMHDemo.Authorization.Users.Profile.Dto;
using MMHDemo.Commands;
using MMHDemo.Core.Threading;
using MMHDemo.Models.NavigationMenu;
using MMHDemo.Services.Navigation;
...
using MMHDemo.ApiClient;
using MMHDemo.Controls;
using MMHDemo.Dto;
using MMHDemo.Extensions;
using MMHDemo.Localization;
using MMHDemo.UI;
using MMHDemo.UI.Assets;
using MMHDemo.Views;
using DependencyResolver = MMHDemo.Core.Dependency.DependencyResolver;
...
namespace MMHDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MMHDemo";
