...
namespace MMHDemo.Web.Authentication.JwtBearer
{
    public class MMHDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public MMHDemoJwtSecurityTokenHandler()
        {
