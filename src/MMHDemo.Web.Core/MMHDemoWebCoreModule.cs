...
using MMHDemo.Web.Configuration;
using MMHDemo.Web.DashboardCustomization;

namespace MMHDemo.Web
{
    [DependsOn(
    ...
    public class MMHDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MMHDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MMHDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MMHDemoWebCoreModule).GetAssembly());
        }
