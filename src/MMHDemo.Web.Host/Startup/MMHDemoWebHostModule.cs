...
{
    [DependsOn(
        typeof(MMHDemoWebCoreModule)
    )]
    public class MMHDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MMHDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MMHDemoWebHostModule).GetAssembly());
        }
