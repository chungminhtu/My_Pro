...
using MMHDemo.Configuration.Host;
using MMHDemo.Editions;
using MMHDemo.Timing;
using MMHDemo.Timing.Dto;
using MMHDemo.Web.Areas.App.Models.HostSettings;
...
namespace MMHDemo.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : MMHDemoControllerBase
    {
