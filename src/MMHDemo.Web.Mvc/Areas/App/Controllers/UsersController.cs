...
using MMHDemo.Authorization.Permissions;
...
using MMHDemo.Web.Areas.App.Models.Roles;
using MMHDemo.Web.Areas.App.Models.Users;
...
namespace MMHDemo.Web.Areas.App.Controllers
{
    ...
    public class UsersController : MMHDemoControllerBase
    {
