...
namespace MMHDemo.Web.Startup
{
    ...
    public class MMHDemoWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MMHDemoWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MMHDemoWebMvcModule).GetAssembly());
        }
