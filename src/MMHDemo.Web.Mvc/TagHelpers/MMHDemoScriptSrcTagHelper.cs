...
namespace MMHDemo.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class MMHDemoScriptSrcTagHelper : TagHelper
    {
        ...
        public MMHDemoScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
