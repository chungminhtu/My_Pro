...
namespace MMHDemo.Web.Public.Startup
{
    ...
    public class MMHDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MMHDemoWebFrontEndModule(IWebHostEnvironment env, MMHDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MMHDemoWebFrontEndModule).GetAssembly());
        }
    }
}
