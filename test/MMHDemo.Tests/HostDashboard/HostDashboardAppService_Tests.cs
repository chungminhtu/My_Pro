...
using MMHDemo.MultiTenancy.HostDashboard;
...
namespace MMHDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MMHDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
